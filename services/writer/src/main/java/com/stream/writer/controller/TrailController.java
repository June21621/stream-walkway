...
public class TrailController {
    ...
    public ResponseEntity<Map<String, String>> handleInvalidTrailData(Exception e) {
        return ResponseEntity.badRequest().body(Map.of("error", "Invalid trail data: " + e.getMessage()));
    }

    @ExceptionHandler(DuplicateTrailException.class)
    public ResponseEntity<Map<String, String>> handleDuplicateTrail(DuplicateTrailException e) {
